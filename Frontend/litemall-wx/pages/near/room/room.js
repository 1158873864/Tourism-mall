...
Page({
  ...
  data: {
    ...
    roomArray: [
      {
        image: '../../../../static/images/ic_hotel_image.png',
        name: '标准单人间',
        service: 'WiFi/有窗/空调',
        price: 158
      }, {
    ...
    serviceList: [
      {
        icon: '../../../../static/images/ic_service_park.png',
        name: '停车场'
      },
      {
        icon: '../../../../static/images/ic_service_food.png',
        name: '营养早餐'
      },
      {
        icon: '../../../../static/images/ic_service_park.png',
  ...
  bookRoom: function (e) {
    ...
    wx.navigateTo({
      url: '../bookroom/bookroom?price=' + room.price + '&hotelName=' + this.data.hotelName + '&roomName=' + room.name + '&startDate=' + startDate + '&endDate=' + endDate,
    })
  },
